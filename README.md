<p align="center">
  <img src="assets/banner.svg" alt="Awesome Prospecting Automation Platform Banner" width="100%" />
</p>
...
<p align="left">
  ...
  <a href="https://github.com/ishandutta2007/Awesome-Prospecting-Automation-Platform"><img src="https://awesome.re/badge.svg" alt="Awesome Badge"/></a>
...
| Repository | GitHub Stars | Focus & Description |
| :--- | :--- | :--- |
| **[NocoBase](https://github.com/nocobase/nocobase)** | [![Star Badge](https://img.shields.io/github/stars/nocobase/nocobase?style=social&color=white)](https://github.com/nocobase/nocobase/stargazers) | Extensible open-source no-code collaboration and CRM platform for managing lead pipelines. |
| **[EspoCRM](https://github.com/espocrm/espocrm)** | [![Star Badge](https://img.shields.io/github/stars/espocrm/espocrm?style=social&color=white)](https://github.com/espocrm/espocrm/stargazers) | Highly customizable open-source CRM application for tracking leads, accounts, and contacts. |
| **[Email Sleuth](https://github.com/buyukakyuz/email-sleuth)** | [![Star Badge](https://img.shields.io/github/stars/buyukakyuz/email-sleuth?style=social&color=white)](https://github.com/buyukakyuz/email-sleuth/stargazers) | Python utility for finding and verifying corporate email addresses via name and domain pattern discovery. |
| **[Oneshot GTM](https://github.com/oneshot-agent/oneshot-gtm)** | [![Star Badge](https://img.shields.io/github/stars/oneshot-agent/oneshot-gtm?style=social&color=white)](https://github.com/oneshot-agent/oneshot-gtm/stargazers) | Open-source Go-to-Market CLI & local dashboard agent for cold email personalizations and pipeline management. |
| **[Warmbly](https://github.com/warmbly/warmbly)** | [![Star Badge](https://img.shields.io/github/stars/warmbly/warmbly?style=social&color=white)](https://github.com/warmbly/warmbly/stargazers) | Open-source self-hosted cold email warmup and deliverability platform for multi-inbox rotation. |
| **[B2B SDR Agent Template](https://github.com/iPythoning/b2b-sdr-agent-template)** | [![Star Badge](https://img.shields.io/github/stars/iPythoning/b2b-sdr-agent-template?style=social&color=white)](https://github.com/iPythoning/b2b-sdr-agent-template/stargazers) | Open-source AI Sales Development Representative template managing multi-stage outbound outreach pipelines. |
| **[Awesome AI Lead Gen](https://github.com/toofast1/awesome-ai-lead-generation)** | [![Star Badge](https://img.shields.io/github/stars/toofast1/awesome-ai-lead-generation?style=social&color=white)](https://github.com/toofast1/awesome-ai-lead-generation/stargazers) | Curated collection of AI tools, scripts, and frameworks for lead generation and social prospect monitoring. |
| **[Coldflow](https://github.com/pypesdev/coldflow)** | [![Star Badge](https://img.shields.io/github/stars/pypesdev/coldflow?style=social&color=white)](https://github.com/pypesdev/coldflow/stargazers) | Functional open-source cold email sequencer supporting CSV contact uploads, spintax templates, and reply detection. |
| **[seqd](https://github.com/getbeton/seqd)** | [![Star Badge](https://img.shields.io/github/stars/getbeton/seqd?style=social&color=white)](https://github.com/getbeton/seqd/stargazers) | Self-hosted personal email sequencer built with Next.js & PostgreSQL featuring Gmail OAuth integrations. |
| **[Harvey AI Sales Agent](https://github.com/ethanplusai/harvey)** | [![Star Badge](https://img.shields.io/github/stars/ethanplusai/harvey?style=social&color=white)](https://github.com/ethanplusai/harvey/stargazers) | Autonomous AI sales outreach agent powered by Claude Code for automated cold email writing and booking. |
| **[OpenOutreach](https://github.com/eracle/OpenOutreach)** | [![Star Badge](https://img.shields.io/github/stars/eracle/OpenOutreach?style=social&color=white)](https://github.com/eracle/OpenOutreach/stargazers) | CLI-based open-source AI agent for B2B prospect discovery, deep company research, and target drafting. |
| **[openleads](https://github.com/Samyrrrrrr990/openleads)** | [![Star Badge](https://img.shields.io/github/stars/Samyrrrrrr990/openleads?style=social&color=white)](https://github.com/Samyrrrrrr990/openleads/stargazers) | Free, self-hosted open-source alternative to Apollo.io for finding and verifying business emails. |
| **[Sequencer](https://github.com/buricodes/sequencer)** | [![Star Badge](https://img.shields.io/github/stars/buricodes/sequencer?style=social&color=white)](https://github.com/buricodes/sequencer/stargazers) | Lightweight drag-and-drop outreach sequence builder with delay scheduling and template variables. |
...
## 📈 Star History
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Prospecting-Automation-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Prospecting-Automation-Platform&type=date&legend=top-left)
